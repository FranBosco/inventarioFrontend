...
export default function Landing() {
	return (
		<div className="containerLanding">
			<h1 className="flex text-cyan-900 font-mono underline underline-offset-2 justify-center pt-48 text-xl sm:text-4xl sm:font-bold sm:pb-10 md:pt-32  md:text-5xl ">
